...
{    
    ...
    public function  __construct() {   
        ...
        $paymentPlugin = db('plugin')->where("code='unionpay' and  type = 'payment' ")->find(); // 找到支付插件的配置
    ...
    {         
		...
		$params = array(
			...
			'txnSubType' => '01',				  //交易子类
			'bizType' => '000201',				  //业务类型
			'frontUrl' => SITE_URL.url('Payment/returnUrl',array('pay_code'=>'unionpay')),  //前台通知地址     SITE_URL.url('User/order_detail',array('id'=>$order['order_id']))
			'backUrl' => SITE_URL.url('Payment/notifyUrl',array('pay_code'=>'unionpay')),	  //后台通知地址   SDK_BACK_NOTIFY_URL
			'signMethod' => '01',	              //签名方法
