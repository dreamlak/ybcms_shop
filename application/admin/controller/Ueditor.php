...
class Ueditor extends Base{
    ...
    public function getContent(){
        echo '<meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
            <script src="/static/js/ueditor/ueditor.parse.js" type="text/javascript"></script>
            <script>' . " uParse('.content',{
                  'highlightJsUrl':'/static/js/ueditor/third-party/SyntaxHighlighter/shCore.js',
                  'highlightCssUrl':/static/js/Ueditor/third-party/SyntaxHighlighter/shCoreDefault.css'
              })</script>";
