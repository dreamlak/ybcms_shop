...
return [
    ...
    'view_replace_str'       => [
    	...
    	'__APP__' => '/application/',
		'__PUBLIC__'=>'/public/',
		'__IMG__'=>$system['img_path'],
		'__JS__'=>$system['js_path'],
		'__CSS__'=>$system['css_path'],
		'__WAP__'=>'/static/wap'
    ],
    // 默认跳转页面对应的模板文件
    'dispatch_success_tmpl'  => ROOT_PATH . 'data/tpl' . DS . 'dispatch_jump.tpl',
    'dispatch_error_tmpl'    => ROOT_PATH . 'data/tpl' . DS . 'dispatch_jump.tpl',
    ...
    'log'                    => [
        ...
        'type'  => 'test',// test可以临时关闭日志写入, 日志记录方式，支持 file socket
        // 日志保存目录
        'path'  => LOG_PATH,
        // 日志记录级别
        'level' => [],
    ...
    'paginate'               => [
        'type'      => 'bootstrap',
        'var_page'  => 'page',
        'list_rows' => $system['index_list_num'],
        'list_admin'=> $system['admin_list_num']
    ],
    
    'captcha'  => [
        // 验证码字符集合
        'codeSet'  => '012345678abcdefghijkmnpqrstuvwxyzABCDEFGHJKLMNPQRTUVWXY', 
        // 验证码字体大小(px)
        'fontSize' => 18, 
        // 是否画混淆曲线
        'useCurve' => false, 
