<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"F:\myweb\ybcms_shop/application/admin\view\index\login.html";i:1497089756;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
<meta charset="utf-8" />
			...
			<ul class="login_input">
				...
				<li>
					...
					<span class="input_vcord">
						<img src="<?php echo captcha_src(); ?>" id="vcordimg" alt="captcha" onclick="verify()" style="height:30px;" />
					</span>
				</li>
			</ul>
...
function verify(){
	...
	$('#vcordimg').attr('src','<?php echo captcha_src(); ?>?t='+Math.random());
}
</script>
</body>
</html>
